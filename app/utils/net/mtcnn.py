...
from keras.layers import (Activation, Conv2D, Dense, Flatten, Input, Permute, Reshape, MaxPool2D)
...
class mtcnn():
    def __init__(self):
        self.Pnet = create_Pnet('D:/code/python/faceweb/app/utils/model_data/pnet.h5')
        self.Rnet = create_Rnet('D:/code/python/faceweb/app/utils/model_data/rnet.h5')
        self.Onet = create_Onet('D:/code/python/faceweb/app/utils/model_data/onet.h5')
