...
def _inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    up = conv2d_bn(mixed,x.shape[channel_axis],1,activation=None,use_bias=True,
...
def InceptionResNetV1(input_shape=(160, 160, 3),
    ...
    # 77,77,64 -> 38,38,64
    x = MaxPool2D(3, strides=2, name='MaxPool_3a_3x3')(x)
    ...
    branch_pool = MaxPool2D(3,strides=2,padding='valid',name=name_fmt('MaxPool_1a_3x3', 2))(x)
    ...
    branch_pool = MaxPool2D(3,strides=2,padding='valid',name=name_fmt('MaxPool_1a_3x3', 3))(x)
